...
What remained open were eight decisions, recorded below. The through-line in all of them is the same: protect the two things that carry the project, which are the hand-written evaluator and slice four's outbox, and spend risk budget nowhere else.

## Key Decisions

- **The repository is public.** Flipped Sep 11 while the tree was still empty, which was the moment with nothing to leak. CodeRabbit's free tier requires public, and CodeRabbit is one of the three reviewers whose comparison table is a stated deliverable.
