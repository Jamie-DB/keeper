...
8. [PROCESS] Never write a file under `app/lib/domain/`, `app/lib/repositories/` or `app/lib/alert_inbox/` for Phases 2 to 4; teach by example instead, through the tested analogous package and phase documents in `docs/learning/`, because the cold-writing claim was retracted on Sep 13, 2026 for a narrower one: Jamie wrote those files by hand, by example, and can explain every line (Jamie, Sep 13, 2026).
