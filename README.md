...
Scaffolded. The Flutter app is in `app/`, generated by Very Good CLI 1.5.0 and still running the template counter. The CI workflow sits at the repository root. No domain code yet.
